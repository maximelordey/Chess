...
public class GameUI {
	...
	private void createWindow(Dimension d) {
		...
		m_newGame = new JMenuItem("Nouvelle Partie");m_newGame.addActionListener(new EvNewGame(m_model.getGame()));
		m_quit = new JMenuItem("Quitter");m_quit.addActionListener(new EvQuit());
